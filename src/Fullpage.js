...
function Section2ndCol() {
    return (
        <div className="w-full h-[40%] p-5 divide-y-2">
                <div className="w-full h-[35%] flex p-2">
                    <div className="w-[60%]"><p className="text-2xl font-bold mt-2">ফটো ফিচার/ নিউইয়র্ক, দুবাই ও লন্ডনে তাঁদের উদ্‌যাপনের রাত</p></div>
                ...
                <div className="w-full h-[35%] flex p-2">
                    <div className="w-[60%]"><p className="text-2xl font-bold mt-2">চাকরি হারিয়ে ভেঙেচুরে গেছেন টুখেল</p></div>
                ...
                <div className="w-full h-[35%] flex mt-5 p-2">
                    <div className="w-[60%]"><p className="text-2xl font-bold ">বলছেন খালেদ মাহমুদ/ মাহমুদউল্লাহর মতো ছেলেকে হঠাৎ ‘নো’ বলা যায় না</p></div>
